...
import os
from transformer2 import LanguageModel
...
def main():
    ...
    sanity_checker.sanity_check(sentence1, block_size, file="Part2a")
    sanity_checker.sanity_check(sentence2, block_size, file="Part2b")
    print()
    print(get_total_params(lm))
